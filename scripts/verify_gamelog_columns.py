"""
Confirms clean_gamelog()'s actual output before trusting game_logs.sql's
column types -- specifically minutes, which nba_api sometimes returns as
"MM:SS" or a float rather than a clean number.
Run: python scripts/verify_gamelog_columns.py PLAYER_ID [SEASON]
Example: python scripts/verify_gamelog_columns.py 1642875 2025-26
"""
